            ...
            <ul>
               ...
               <li class="col-md-4">
                  <div class="item-content">
                     ...
                     <h3>{{ $product->name }}</h3> 
                     {{-- {{{ dd($product->name) }}} --}}
                     <form id="storeCart" class="storeCart" action="{{ route('store_cart') }}"  method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
   ...
   <div class="container">
      <div class="row">
         ...
         <div class="contact-form">
            <form id="contactForm" action="{{ route('contact_form') }}" method="POST" class="cont-fo">
               {{ csrf_field() }}
               <div class="col-md-6">
