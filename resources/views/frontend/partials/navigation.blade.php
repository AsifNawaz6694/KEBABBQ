		...
		<ul class="nav navbar-nav">
			<li class="dropdown dropdown-large">
				...
				<ul class="dropdown-menu dropdown-menu-large row">
					<li class="col-sm-3">
						<ul>
							<li class="dropdown-header">Karahi</li>
							<li><a href="javascript:void(0)">Meat Karahi</a></li>
						<li><a href="javascript:void(0)">Chicken Karahi</a></li>
						<li><a href="javascript:void(0)">Mixed Dal</a></li>
							<li class="divider"></li>
							<li class="dropdown-header">Rice</li>
							<li><a href="javascript:void(0)">Mutton Biryani</a></li>
						<li><a href="javascript:void(0)">Chicken Biryani</a></li>
						<li class="divider"></li>
						<li class="dropdown-header">Sides</li>
						<li><a href="javascript:void(0)">Regular Chips</a></li>
						<li><a href="javascript:void(0)">Large Chips</a></li>
					...
					<li class="col-sm-3">
						...
						<li><a href="javascript:void(0)">Cooked Tea with Fresh Milk</a></li>
						<li class="divider"></li>
					<li class="dropdown-header">Wraps</li>
					<li><a href="javascript:void(0)">Chicken Shawarma (Regular)</a></li>
						<li><a href="javascript:void(0)">Shawarma (Large)</a></li>
						<li class="divider"></li>					
						
							<li class="dropdown-header">Hot Tandoor</li>
							<li><a href="javascript:void(0)">Tandoori Roti</a></li>
						<li><a href="javascript:void(0)">Tandoori Naan</a></li>
						</ul>
					</li>
					<li class="col-sm-3">
						<ul>
							<li class="dropdown-header">Grilled</li>
					...
					<li class="col-sm-3">
						<ul>
							<li class="dropdown-header">Salads</li>
							<li><a href="javascript:void(0)">Green Salad</a></li>
							<li><a href="javascript:void(0)">Kebab Salad</a></li>
							<li><a href="javascript:void(0)">Green Yoghurt Chutney</a></li>
							<li><a href="javascript:void(0)">Kebab Chutney</a></li>
							<li class="divider"></li>	
							<li class="dropdown-header">Roasted</li>
							<li><a href="javascript:void(0)">Full Peri Peri Chicken</a></li>
							<li><a href="javascript:void(0)">Half Peri Peri Chicken</a></li>
