...
<head>
<meta charset="utf-8">
<title>whoops! | responsive 404 template | themeforest | josweb</title>
...
/* Menu */
.menu { margin: 30px 0 20px; text-transform: uppercase; font-size: 11px; }
.menu a { color: #333; }
	...
	<div class="row">		
		<div class="span12">
			...
			<div class="fade-in one">
				<div id="whoops">
					<img src="<?php echo e(asset('public/assets/img/404_dark.png')); ?>" alt="" class="animated swing">
				</div>
			</div>
		</div>
			...
			<h1 class="fade-in two">The page you are looking for seems to be missing</h1>
