...
<html>
   <head>
      ...
      <title>AdminKEBABBQ | Log in</title>
      <!-- Tell the browser to be responsive to screen width -->
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <!-- <link rel="stylesheet" href="<?php echo e(asset('public/assets/img/logo.png')); ?>" type="image/png" sizes="25x25"> -->
      ...
      <!-- <link rel="stylesheet" href="<?php echo e(asset('public/bower_components/alertify/themes/alertify.default.css')); ?>"> -->
      ...
      <!-- Theme style -->
      <link rel="stylesheet" href="<?php echo e(asset('public/admin_assets/dist/css/adminlte.min.css')); ?>">
      <!-- iCheck -->
      <link rel="stylesheet" href="<?php echo e(asset('public/admin_assets/plugins/iCheck/square/blue.css')); ?>">
   ...
   <body class="hold-transition login-page">
    <?php echo $__env->make('general_partials.error_section', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      <div class="login-box">
         ...
         <div class="card">
            <div class="card-body login-card-body">
               ...
               <form id="signin_form" action="<?php echo e(route('login_post')); ?>" method="post">
                  <?php echo e(csrf_field()); ?>

                  <div class="imgcontainer">
                     <img src="<?php echo e(asset('public/admin_assets/img/download.jpg')); ?>" alt="Avatar" class="avatar">
                  </div>
                  <div class="container">
      ...
      <!-- Bootstrap 4 -->
      <script src="<?php echo e(asset('public/admin_assets/plugins/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
      <!-- iCheck -->
      <script src="<?php echo e(asset('public/admin_assets/plugins/iCheck/icheck.min.js')); ?>"></script>
      <script>
         $(function () {
           $('input').iCheck({
